...
//   return (
//     <>
//     <div className="bg-black w-full text-white pb-16 pt-20">
//         <div className="flex max-w-screen-xl mx-auto gap-14">
//           <div className="lg:basis-5/12 text-sm text-[#ABA3A3]">
//             {/* <h1 className="uppercase text-4xl mb-4 text-white font-heading">LOGO</h1> */}

//             <Image
//               className="w-28 ml-[-10px] mb-3"
...
//                   <p className="">info@oceantechies.com</p>
//                 </Link>
//               </div>
//               <div className="flex gap-2 mb-3 items-center">
//                 <Image
...
//             </div>
//           </div>
//           <div className="lg:basis-7/12 flex">
...
//                 <Link href="/disclaimer">Unit Configuration</Link>
//               </div>
//             </div>
//             <div className="basis-1/2">
//               <h3 className="uppercase underline underline-offset-4 text-base mb-4 font-heading">
